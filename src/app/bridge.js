...
function hello() {
  ...
  /* No 'capabilities' push: what the gear and the update button can do is a
     fact about the EXTENSION's manifest, and the side panel has the same
     manifest this file does. It asks directly, which is right in states this
     side never reaches — chiefly "no page connected at all". */
